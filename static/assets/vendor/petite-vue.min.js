var __defProp = Object.defineProperty,
    ...
    PetiteVue = (function (e) {
        ...
        const f = Object.assign,
            ...
            w = /-(\w)/g,
            $ = x((e) => e.replace(w, (e, t) => (t ? t.toUpperCase() : ''))),
            k = /\B([A-Z])/g,
            O = x((e) => e.replace(k, '-$1').toLowerCase()),
            S = (e) => {
        ...
        const he = [],
                ...
                if ('class' === t)
                    ...
                    if (s)
                        if (m(s)) s !== r && (t.cssText = s)
                            ...
                            if (r && !m(r))
                                for (const e in r) null == s[e] && we(t, e, '')
                        }
            ...
            we = (e, t, n) => {
                p(n)
                    ? n.forEach((n) => we(e, t, n))
                    : t.startsWith('--')
                      ? e.setProperty(t, n)
                      : xe.test(n)
                        ? e.setProperty(O(t), n.replace(xe, ''), 'important')
                        : (e[t] = n)
            },
            $e = (e, t) => {
            ...
            Re = (e) => ('_value' in e ? e._value : e.value),
            Ne = (e, t) => {
                    ...
                    if ('SELECT' === e.tagName) {
                        ...
                        ke(e, 'change', () => {
                            ...
                            s(() => {
                                const s = n()
                                p(s)
                                    ? (e.checked = l(s, Re(e)) > -1)
                                    : s !== t && (e.checked = c(s, Ne(e, !0))),
                                    (t = s)
                            })
                    } else if ('radio' === i) {
                        let t
